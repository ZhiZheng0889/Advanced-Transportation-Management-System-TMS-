...
check_credentials <- function(username, password) {
  user <- dbGetQuery(
    con,
    'SELECT * FROM "TMS_USERS" WHERE "username" = $1 AND "password" = $2',
...
add_user <- function(username, password) {
  ...
  dbExecute(
    con,
    'INSERT INTO "TMS_USERS" ("userid", "username", "password", "role") VALUES ($1, $2, $3, $4)',
    params = list(userid, username, password, 'Customer')
  )
}
